...
func (c *thingModelDownServiceClient) ThingModelMsgIssue(ctx context.Context, in *ThingModelIssueMsg, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, ThingModelDownService_ThingModelMsgIssue_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *messageRateServiceClient) MessageRate(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*MessageRateResponse, error) {
	...
	err := c.cc.Invoke(ctx, MessageRateService_MessageRate_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedMessageRateServiceServer must be embedded to have forward compatible implementations.
...
func (UnimplementedMessageRateServiceServer) MessageRate(context.Context, *emptypb.Empty) (*MessageRateResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method MessageRate not implemented")
}
