...
func (c *deviceCallBackServiceClient) BatchCreateDeviceCallback(ctx context.Context, in *BatchCreateDeviceCallback, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, DeviceCallBackService_BatchCreateDeviceCallback_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *deviceCallBackServiceClient) BatchDeleteDeviceCallback(ctx context.Context, in *BatchDeleteDeviceCallback, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, DeviceCallBackService_BatchDeleteDeviceCallback_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedDeviceCallBackServiceServer) CreateDeviceCallback(context.Context, *CreateDeviceCallbackRequest) (*emptypb.Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method CreateDeviceCallback not implemented")
}
func (UnimplementedDeviceCallBackServiceServer) UpdateDeviceCallback(context.Context, *UpdateDeviceCallbackRequest) (*emptypb.Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method UpdateDeviceCallback not implemented")
}
func (UnimplementedDeviceCallBackServiceServer) DeleteDeviceCallback(context.Context, *DeleteDeviceCallbackRequest) (*emptypb.Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method DeleteDeviceCallback not implemented")
}
func (UnimplementedDeviceCallBackServiceServer) BatchCreateDeviceCallback(context.Context, *BatchCreateDeviceCallback) (*emptypb.Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method BatchCreateDeviceCallback not implemented")
}
func (UnimplementedDeviceCallBackServiceServer) BatchDeleteDeviceCallback(context.Context, *BatchDeleteDeviceCallback) (*emptypb.Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method BatchDeleteDeviceCallback not implemented")
}
...
func _DeviceCallBackService_BatchCreateDeviceCallback_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(BatchCreateDeviceCallback)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DeviceCallBackServiceServer).BatchCreateDeviceCallback(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DeviceCallBackService_BatchCreateDeviceCallback_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DeviceCallBackServiceServer).BatchCreateDeviceCallback(ctx, req.(*BatchCreateDeviceCallback))
	}
	return interceptor(ctx, in, info, handler)
}
